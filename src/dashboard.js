...
mapboxgl.accessToken =
  "pk.eyJ1IjoicnNzLW1vdG9ycy1kcHNubSIsImEiOiJja3M5d2J6MG8yMTB0MnZwaHN5MWJ4b2VjIn0.XkTBH9onasR65R4KtW_CoA";
...
class Dashboard extends Component {
  ...
  componentDidMount() {
    const theme =
      window.localStorage.getItem("theme") === "theme-dark" ? "night" : "day";
